---
title: Memory
description: Memory is a runtime feature of the KKOCLAW Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
---
...
<Callout type="info" emoji="💾">
  Memory lets KKOCLAW carry useful information across sessions. The agent
...
Memory is a runtime feature of the KKOCLAW Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
...
memory:
  ...
  # Default: {base_dir}/memory.json  (resolves to backend/.oclaw/memory.json)
  ...
  storage_class: kkoclaw.agents.memory.storage.FileMemoryStorage
...
KKOCLAW supports two levels of memory:
...
- Base directory: `backend/.oclaw/`
- Global memory: `backend/.oclaw/memory.json`
- Per-agent memory: `backend/.oclaw/agents/{agent_name}/memory.json`
