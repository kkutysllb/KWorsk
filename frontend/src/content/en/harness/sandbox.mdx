...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes KKOCLAW capable of real action, not just
  conversation.
</Callout>
...
KKOCLAW supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: kkoclaw-sandbox)
...
| `.oclaw/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
