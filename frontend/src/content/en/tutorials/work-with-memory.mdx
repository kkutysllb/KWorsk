...
description: This tutorial shows you how to enable and use KKOCLAW's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use KKOCLAW's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.oclaw/memory.json`:

```bash
cat backend/.oclaw/memory.json
```
...
```
backend/.oclaw/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own KKOCLAW](/docs/tutorials/deploy-your-own-kkoclaw)
