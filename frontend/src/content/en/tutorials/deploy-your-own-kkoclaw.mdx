...
description: This tutorial guides you through deploying KKOCLAW to a production environment using Docker Compose for multi-user access.
---
...
This tutorial guides you through deploying KKOCLAW to a production environment using Docker Compose for multi-user access.
...
```bash
git clone https://github.com/kkOClaw/kkoclaw.git
cd kkoclaw
```
...
- Back up `backend/.oclaw/` directory regularly
