#!/usr/bin/env python3
"""调用 Finance Hub API: cnCompanyBasicInfo — A股公司基础信息

Usage:
    python3 call_cnCompanyBasicInfo.py --symbol sh688111
    python3 call_cnCompanyBasicInfo.py --symbol sz000002
...
def main():
    ...
    parser = argparse.ArgumentParser(description="调用 cnCompanyBasicInfo — A股公司基础信息")
    parser.add_argument("--symbol", required=True, help='股票代码，如 sh688111 / sz000002')
