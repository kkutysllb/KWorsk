#!/usr/bin/env python3
"""调用 Finance Hub API: usTradingFundFlow60Days — 美股主力资金历史

Usage:
    python3 call_usTradingFundFlow60Days.py --symbol aapl --days 60
...
BASE_URL = "https://mcp.finance.sina.com.cn/api-call/usTradingFundFlow60Days"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="调用 usTradingFundFlow60Days — 美股主力资金历史")
    parser.add_argument("--symbol", required=True, help='美股代码，如 aapl')
