#!/usr/bin/env python3
"""调用 Finance Hub API: newsSearch（新闻搜索）

按关键词搜索财经新闻，覆盖官媒、主流财经媒体、垂直行业网站等。

Usage:
    python3 call_api.py --keyword "关税政策,贸易战" [--page 1] [--num 10]
...
BASE_URL = "https://mcp.finance.sina.com.cn/api-call/newsSearch"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="搜索财经新闻（newsSearch API）")
    parser.add_argument("--keyword", required=True,
                        help="关键词，多个用英文逗号分隔，最多10个，每个最长15字符。示例：'关税政策,贸易战'")
